...
export default function RegisterCNPJForm({ onSwitchToCPF, onClose, onSuccess }) {
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        {/* Responsável + Celular */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <input type="text" name="responsavel" placeholder="Nome do responsável pela compra*" required
            className="w-full border border-gray-400 px-4 py-3 text-sm outline-none focus:border-gray-600" />
          <input type="tel" name="celular" placeholder="Celular para contato*" required
            className="w-full border border-gray-400 px-4 py-3 text-sm outline-none focus:border-gray-600" />
        </div>

        {/* Inscrição Estadual + Tributárias */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <input type="text" name="inscricaoEstadual" placeholder="Inscrição Estadual*" required
            className="w-full border border-gray-400 px-4 py-3 text-sm outline-none focus:border-gray-600" />
          <div className="relative">
            <select name="informacoesTributarias" required
              ...
              <option value="" disabled defaultValue>Informações tributárias</option>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
          <button type="button" onClick={onSwitchToCPF}
